...
export default function About() {
  return (
    <Container title="About – Mustaqim Arifin">
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16 w-full px-8">
        ...
        <div className="mb-8 prose dark:prose-dark leading-6">
          ...
          <ul>
            ...
            <li>
              GitHub:{' '}
              <a href="https://github.com/mustaqimarifin">@mustaqimarifin</a>
            </li>
            <li>
              Website:{' '}
          ...
          <h2>Bio</h2>
          <h3>Job Title</h3>
          <p>Mustaqim Arifin, VP of Developer Experience at Vercel</p>
          <h3>Long, 3rd Person</h3>
          <p>
            Mustaqim Arifin is the VP of Developer Experience at{' '}
          ...
          <h3>Education</h3>
          <p>
            Mustaqim Arifin graduated from Iowa State University with a B.S. in
