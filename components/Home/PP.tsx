...
export default function PP() {
  ...
  return (
    <Detail.Container data-cy="pp" ref={scrollContainerRef}>
      ...
      />
      <>
        <div className="prose-sm mx-auto flex max-w-2xl flex-col items-start justify-start border-gray-200 pb-16 text-left  text-gray-600 prose-headings:font-bold dark:prose-invert dark:border-gray-700 dark:text-gray-300">
          <h1 className="mt-8 flex h-6  leading-7 transition-all">
            ...
            <svg
              ...
              fill="none"
              viewBox="0 0 24 24"
              className="ml-1 h-10 w-8 animate-pulse duration-1000 ease-out"
            >
              <path
                stroke="currentColor"
                strokeLinecap="round"
