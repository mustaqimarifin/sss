...
export default function PP() {
  ...
  return (
    <Detail.Container data-cy="pp" ref={scrollContainerRef}>
      ...
      />
      <>
        <div className="prose-sm mx-auto flex max-w-2xl flex-col items-start justify-start border-gray-200 pb-16 text-left  text-gray-600 prose-headings:font-bold dark:prose-dark dark:border-gray-700 dark:text-gray-300">
