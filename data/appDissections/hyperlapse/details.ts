export default [
  {
    ...
    title: 'Onboarding',
    media: [
      'https://player.vimeo.com/external/157935899.sd.mp4?s=cef3f01ecfdb984d4d3a76486cf506dde788d15f&profile_id=165'
    ]
  },
  {
    description:
    ...
    title: 'Signing in',
    media: [
      'https://player.vimeo.com/external/157935901.sd.mp4?s=2b6aac94cec597b8b9db343233177cef9314a00b&profile_id=165'
    ]
  },
  {
    description:
    ...
    media: [
      'https://player.vimeo.com/external/157935900.sd.mp4?s=648aeffb46c5196dc330bf177f0febcf9a46dedc&profile_id=165'
    ]
  },
  {
    description:
    ...
    title: 'Brightness',
    media: [
      'https://player.vimeo.com/external/157935902.sd.mp4?s=3f1cf8ba2403cd3d8b57b44d71f6e7e30f097d12&profile_id=165'
    ]
  },
  {
    description:
    ...
    media: [
      'https://player.vimeo.com/external/157935903.sd.mp4?s=2989bbfde5c97113212521d74493bfe7dbd5f113&profile_id=165'
    ]
  },
  {
    description:
    ...
    title: 'Rate changing',
    media: [
      'https://player.vimeo.com/external/157935905.sd.mp4?s=622885b6bbcb1e2523ae220ee47b00be8acdd2b8&profile_id=165'
    ]
  },
  {
    description:
    ...
    title: 'Unstabilized',
    media: [
      'https://player.vimeo.com/external/157935906.sd.mp4?s=25b501ed0c1104ce2cdee3a16c43b4755d30bee2&profile_id=165'
    ]
  },
  {
    description:
    ...
    title: 'Deleting',
    media: [
      'https://player.vimeo.com/external/157935907.sd.mp4?s=10de83b6cb6c44cd722f414fa92391504f21934d&profile_id=165'
    ]
  },
  {
    description:
    ...
    media: [
      'https://player.vimeo.com/external/157935909.sd.mp4?s=fbaebe0fd74dbba2f1120b818afd56f0b386787d&profile_id=165'
    ]
  },
  {
    description:
    ...
    title: 'Lock focus',
    media: [
      'https://player.vimeo.com/external/157935908.sd.mp4?s=c9bd7fda712d63d851e3da822b060416919bb51d&profile_id=165'
    ]
  },
  {
    description:
    ...
    title: 'Save and edit',
    media: [
      'https://player.vimeo.com/external/157935911.sd.mp4?s=5b5f17ebf08c9054619052572efefe11619e1105&profile_id=165'
    ]
  }
];
