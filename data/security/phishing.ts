export default {
  ...
  resources: [
    ...
    },
    {
      ...
      url: 'https://www.gimletmedia.com/reply-all/97-what-kind-of-idiot-gets-phished'
    },
    {
      name: 'Common phishing attacks and how to protect against them',
      url: 'https://www.tripwire.com/state-of-security/security-awareness/6-common-phishing-attacks-and-how-to-protect-against-them/'
    },
    {
    ...
    },
    {
      ...
      url: 'https://chrome.google.com/webstore/detail/password-alert/noondiphcddnnabmjcihcjfbhfklnnep?hl=en'
    }
  ]
};
